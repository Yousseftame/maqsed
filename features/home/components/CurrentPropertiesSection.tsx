    ...
    <section className="relative z-30 w-full bg-white px-6 py-24 md:px-12 lg:px-20">
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="text-center mb-16 flex justify-center">
          <h2 className="text-4xl md:text-5xl font-bold text-[#0a0f1d] flex justify-center">
            <DiaTextReveal
        ...
        <div className="relative w-full group">
          ...
          <button
            ...
            className="absolute -left-4 lg:-left-6 top-[35%] -translate-y-1/2 z-20 w-12 h-12 flex items-center justify-center rounded-full bg-[#1c1c1c] shadow-lg text-white opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-black hover:scale-110 disabled:opacity-0"
          >
          ...
          <button
            ...
            className="absolute -right-4 lg:-right-6 top-[35%] -translate-y-1/2 z-20 w-12 h-12 flex items-center justify-center rounded-full bg-[#1c1c1c] shadow-lg text-white opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-black hover:scale-110 disabled:opacity-0"
          >
                ...
                <div className="flex flex-col bg-white h-full select-none">
                  ...
                  <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden mb-5 group/card cursor-grab active:cursor-grabbing">
                    ...
                    <div className="absolute top-4 start-4 flex items-center gap-2 z-10 pointer-events-none">
                      {/* Property Type Badge */}
                      <div className="bg-[#1a1f2e] text-white px-3 py-1.5 rounded-[10px] font-bold text-sm shadow-md">
                      ...
                      {/* Property Tier Badge */}
                      <div className="bg-white/95 backdrop-blur-md text-[#0a0f1d] px-3 py-1.5 rounded-[10px] font-bold text-sm shadow-md">
                        {project.id % 3 === 0 
                          ? (isRtl ? "فاخرة" : "Luxury")
                          : project.id % 3 === 1 
                  ...
                  <div className="flex items-end justify-between gap-4 px-1 pb-4">
                    ...
                    <Link 
                      ...
                      className="bg-[#1c1c1c] text-white text-sm font-bold px-6 py-2.5 rounded-[18px] whitespace-nowrap transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:bg-white hover:text-[#1c1c1c] hover:ring-1 hover:ring-[#1c1c1c]/15 active:scale-[0.98]"
                      draggable={false}
                    >
