export interface Dictionary {
  ...
  admin: {
    ...
    offers: {
      ...
      technicalDetailsPlaceholder: string;
      financialAmount: string;
      financialAmountPlaceholder: string;
      developerEmail: string;
      developerEmailPlaceholder: string;
      developerPhone: string;
      developerPhonePlaceholder: string;
      developerName: string;
      developerNamePlaceholder: string;
      cancel: string;
      submit: string;
      submitting: string;
...
export const en: Dictionary = {
  ...
  admin: {
    ...
    offers: {
      create: "Create Offer",
      createFor: "Create Offer for Developer",
      offerTitle: "Offer Title",
      offerTitlePlaceholder: "e.g. Phase 1 Development",
      projectName: "Project Name",
      projectNamePlaceholder: "e.g. Al-Riyadh Compound",
      technicalDetails: "Technical Details",
      technicalDetailsPlaceholder: "Describe the scope of work...",
      financialAmount: "Financial Amount (SAR)",
      financialAmountPlaceholder: "e.g. 50000",
      developerEmail: "Developer Email",
      developerEmailPlaceholder: "dev@example.com",
      developerPhone: "Developer Phone",
      developerPhonePlaceholder: "+966 50...",
      developerName: "Developer Name",
      developerNamePlaceholder: "e.g. Ahmed Ali",
      cancel: "Cancel",
      submit: "Create & Send Offer",
      submitting: "Creating...",
      successMessage: "Offer created successfully! OTP will be generated by Cloud Function.",
